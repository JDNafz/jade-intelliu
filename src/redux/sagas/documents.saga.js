...
//   try {
//     const updateJSON = yield axios.put(`/api/documents/${action.payload.id}`, action.payload);
//     console.log(updateJSON)
//     yield put({ type: 'SET_RESULTS', payload: updateJSON});
